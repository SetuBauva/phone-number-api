...
public class PhoneNumberController {
	...
	@PutMapping("/activatePhoneNumbers")
	public ResponseEntity<PhoneNumbers> updatePhoneNumber(@RequestBody PhoneNumbers pn)
	{
		 ...
		 return new ResponseEntity<PhoneNumbers>(pn, HttpStatus.CREATED);
		 else return new ResponseEntity<PhoneNumbers>( HttpStatus.NOT_FOUND);
	}
